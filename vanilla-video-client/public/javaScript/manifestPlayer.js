...
function addPlayer(player) {
  ...
  if (
    ...
    // If we don't have a wrapper the buttons havent been created yet, so lets create them.
    if (!wrapper) {
        ...
        document.getElementById("playerPlayButton").addEventListener("click", handlePlayerPlay);
        document.getElementById("playerMuteButton").addEventListener("click", handlePlayerMute);
        document.getElementById("playerFullScreenButton").addEventListener("click", handlePlayerFullScreen);
    }
